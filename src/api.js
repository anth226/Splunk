...
export const api = axios.create({
  ...
  baseURL: process.env.REACT_APP_STATE === 'development'
    ...
    : `${window.location.href.slice(0, (window.location.href.length - 1))}:8000/en-US/splunkd/__raw/servicesNS/nobody/apmTest2/api/sets`,
  headers: {
...
export const getDetails = (property, name) => api.get(`/${property}/entities/${name}`);
